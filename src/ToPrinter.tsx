...
//   return (
//     <>
//       <div id="area-impressao" className="w-[210mm] h-[297mm] mx-auto text-maiuscula font-sans pt-8 px-15 flex flex-col overflow-hidden shadow-sm print:shadow-none">
...
//                 <div className="flex items-baseline grow">
//                   <span className="shrink-0 mr-1 text-[0.65rem] font-bold uppercase">
...
//                 </div>
//                 <div className="flex items-baseline shrink-0">
//                   <span className="shrink-0 mr-1 text-[0.65rem] font-bold uppercase">MAT.</span>
//                   <div className="border-b border-black flex grow ml-1">
...
//             <div className="flex items-baseline grow">
//               <span className="shrink-0 mr-1">ÓRGÃO SUBORDINANTE</span>
//               <div style={{ borderBottom: '1px solid #000000' }} className="flex grow ml-1">
//                 <span className="text-minuscula">{dados.orgaoSubordinante}</span>
//               </div>
//             </div>
//             <div className="flex items-baseline shrink-0">
